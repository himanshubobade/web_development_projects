...
<head>
        ...
        <link rel="shortcut icon" href="http://cgcm.in/assets/img/gallery.jpg">
                        ...
                        <div class="card">
                            <div class="card-body p-4">
                                <div class="p-2">
                                    ...
                                    <form class="form-horizontal" action="<?php echo base_url('hello-admin/login/apply-login-credentials') ?>" method="POST">
