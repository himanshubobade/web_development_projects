                ...
                <div data-simplebar class="h-100">
                    ...
                    <div id="sidebar-menu" class="nunito_fonts">
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                                <a href="<?= base_url() ?>hello-admin/ca-actions" class="waves-effect">
                            ...
                            <li>
                                <a href="<?= base_url() ?>hello-admin/action-request" class="waves-effect">
                                    <i class="mdi mdi-account"></i>
                                    <span>Action Request</span>
                                </a>
                            </li>
                            <li>
                                <a href="<?= base_url() ?>hello-admin/action-submissions" class="waves-effect">
                                    <i class="mdi mdi-forum"></i>
                                    <span>Action Submissions</span>
                                </a>
                            </li>
                            
                            <li>
                                <a href="<?= base_url() ?>hello-admin/country-ambasadors" class="waves-effect">
                                    <i class="mdi mdi-account"></i>
                                    <span>Country Ambasador</span>
                                </a>
                            </li>
