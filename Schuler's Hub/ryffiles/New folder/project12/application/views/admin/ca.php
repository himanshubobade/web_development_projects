                ...
                <div class="page-content">
                    <div class="container-fluid">
						...
						<div class="row">
                            ...
                            <div class="col-12">
								<div class="card">
                                    <div class="card-body p-20">
										...
										<form action="campus-ambasadors" method="POST" onsubmit = "return checkForBlankSubmission()">
											<div class="row">
                                        ...
                                        <div class="table-responsive">
											...
											<tbody>
												...
												if(isset($_POST['submit'])){
													/*if($_POST['country'] == NULL && $_POST['state'] == NULL && $_POST['status'] == NULL){
														$country = "";
														$state = "";
														$status = "";
													}
													else if($_POST['country'] == NULL && $_POST['state'] != NULL && $_POST['status'] != NULL){
														$country = "";
														$state = $_POST['state'];
														$status = $_POST['status'];
													...
													#var_dump($state);
													#var_dump($status);
													#echo "country" . $country . "state" . $state . "status" . $status ;
													if($country != "" && $state !="" && $status !=""){
														foreach($campusambasadorsarray as $key){
															if($key->country == $country && $key->state == $state && $key->status == $status){
																?>
																	<tr>
													...
													}else if($country != "" && $state == "" && $status == ""){
														######################   for a single country value   ####################
														foreach($campusambasadorsarray as $key){
														...
														foreach($campusambasadorsarray as $key){
															if($key->country == $country && $key->state == $state){
																?>
																<tr>
																	<td><?php echo $key->id;?></td>
																	<td><?php echo $key->name;?></td>
														...
														if($key->state == $state && $key->status == $status){
															?>
																<tr>
																		<td><?php echo $key->id;?></td>
																		<td><?php echo $key->name;?></td>
														...
														if($key->country == $country && $key->status == $status){
															?>
																<tr>
																		<td><?php echo $key->id;?></td>
																		<td><?php echo $key->name;?></td>
							...
							<script>
								function checkForBlankSubmission(){
									if(document.getElementById("country_").value == "" && document.getElementById("state_").value == "" && document.getElementById("status_").value == ""){
										alert("Please enter values for filteration!!");
										return false;
									}
								}
							</script>
						...
						<!----------------------------------  THIS SECTION WAS EXPERIMENTED FOR JAVASCRIPT FILTERS
						<div class="col-12">
								<div class="card">
                                    <div class="card-body p-20">
										<h4 class="mb-3"><i class="mdi mdi-server-network"></i> Filter</h4>
                                            ...
                                            <table id="datatable" class="table table-bordered dt-responsive " >
												...
												<tbody>
													...
													<?php /*
														...
														foreach($campusambasadorsarray as $key){
															?>
															<td id="caid<?php echo $i;?>">.</td>
															<td id="caname<?php echo $i;?>">.</td>
															<td id="caemail<?php echo $i;?>">.</td>
															<td id="camobile<?php echo $i;?>">.</td>
															<td id="capoints<?php echo $i;?>">.</td>
															<td id="cacollege<?php echo $i;?>">.</td>
															<td id="cacourse<?php echo $i;?>">.</td>
															<td><a href="<?= base_url() ?>hello-admin/campus-ambasadors/edit-campus-ambasadors/<?php echo $key->id;?>" class="btn btn-dark waves-effect waves-light">Edit</a><br><br></td>
															</tr>
												</tbody>
															<?php
															#echo $campusambasadorsarray[$i]->name;
															?>
															<script>
																var caid = "<?php echo $campusambasadorsarray[$i]->id; ?>";
																var caname = "<?php echo $campusambasadorsarray[$i]->name; ?>";
																var caemail = "<?php echo $campusambasadorsarray[$i]->email; ?>";
																var camobile = "<?php echo $campusambasadorsarray[$i]->mobile; ?>";
																var capoints = "<?php echo $campusambasadorsarray[$i]->points; ?>";
																var cacourse = "<?php echo $campusambasadorsarray[$i]->course ."<br>". $campusambasadorsarray[$i]->year; ?>";
																var cacollege = "<?php echo $campusambasadorsarray[$i]->college; ?>";
																//var caaction = "<?php echo $campusambasadorsarray[$i]->id; ?>";
																document.getElementById("caid<?php echo $i;?>").innerHTML = caid;
																document.getElementById("caname<?php echo $i;?>").innerHTML = caname;
																document.getElementById("caemail<?php echo $i;?>").innerHTML = caemail;
																document.getElementById("camobile<?php echo $i;?>").innerHTML = camobile;
																document.getElementById("capoints<?php echo $i;?>").innerHTML = capoints;
																document.getElementById("cacollege<?php echo $i;?>").innerHTML = cacollege;
																document.getElementById("cacourse<?php echo $i;?>").innerHTML = cacourse;
																//document.getElementById("caaction<?php echo $i;?>").innerHTML = caaction;
																//console.log(caid);
															</script>
															<?php
															$i= $i + 1;
													...
													<?php 
														...
														#foreach($campusambasadorsarray as $key){
															?>
															<!--<p id="hello<?php #echo $i;?>">Helllooooowww</p>-->
															<?php
															#echo $campusambasadorsarray[$i]->name;
															?>
															<script>
																//var simple = "<?php #echo $campusambasadorsarray[$i]->name; ?>";
																//document.getElementById("hello<?php #echo $i;?>").innerHTML = simple;
																//console.log(simple);
															</script>
															<?php
															#$i= $i + 1;
													...
													?>
														...
														<script>
															//var simple = "<?php #echo $campusambasadorsarray[i]->name; ?>";
															//document.getElementById("hello").innerHTML = simple;
															//console.log(simple);
														</script>
					</div>
				</div>
