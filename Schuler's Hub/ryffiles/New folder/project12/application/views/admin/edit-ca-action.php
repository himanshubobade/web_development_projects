                                ...
                                <div class="card">
									...
									<form method="post" action="<?= base_url() ?>hello-admin/ca-actions/update-ca-action/update" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <input placeholder="Title of the Action" required class="form-control" name="title" value="<?php echo $caactions->title; ?>" />
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-md-2 col-form-label  font-18 font-weight-400">Description of Action</label>
                                            <div class="col-md-10">
                                                <textarea placeholder="Description of Action" required class="form-control" name="description"><?php echo $caactions->description; ?></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <input placeholder="Link of the Action" type="text" class="form-control" name="link" value="<?php echo $caactions->link; ?>" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <input placeholder="Points of the Action" type="number" required class="form-control" name="point" value="<?php echo $caactions->point; ?>" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-10">
                                                <button type="submit" class="btn btn-primary mt-2" name="caactionid" value="<?php echo $caactions->id; ?>">Update Campus Ambasador Action</button>
                                            </div>
                                        </div>
