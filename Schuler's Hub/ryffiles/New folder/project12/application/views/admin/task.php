                                    ...
                                    <div class="card-body p-20">
										<div class="row">
											<div class="col-md-8">
												...
												<a href="<?= base_url() ?>hello-admin/ca-tasks/add-new-ca-task" class="btn btn-info font-16">Add New Task</a>
											</div>
                                    ...
                                    <div class="card-body p-20">
										...
										<form>
											<div class="row">
											  ...
											  <div class="form-group col-md-4">
												<label class="font-18 font-weight-400">Pending</label>
												<select class="form-control">
												  <option value="0">Pending</option>
												  <option value="1">Not Pending</option>
												</select>
											  </div>
                                              <div class="form-group col-md-4" style="padding: 35px;">
										...
										<div class="">
                                            ...
                                            <table id="datatable" class="table table-bordered dt-responsive " >
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="<?= base_url() ?>hello-admin/ca-tasks/edit-ca-tasks/<?php echo $key->id;?>" class="btn btn-dark waves-effect waves-light">Edit</a><br><br></td>
                                                </tr>
