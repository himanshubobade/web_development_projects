						...
						<div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-36 nunito_fonts">Submit Report</h4>
                                ...
                                <div class="card">
									...
									<form method="post" action="<?= base_url() ?>submit-report/submit" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-md-2 col-form-label font-18 font-weight-400">Select Task</label>
                                            <div class="col-md-10">
