				...
				<div class="col-sm-6 col-xl-3">
					<div class="card">
						<div class="card-body">
							<div class="media">
								<div class="media-body">
									<h5 class="font-size-18 font-weight-400">Total Impact Points</h5>
									<h4 class="m-0 align-self-center font-weight-700 theme_coLor"><?php echo $numpointsca;?></h4>
								</div>
								<div class="avatar-xs">
									<span class="avatar-title rounded-circle">
				...
				<div class="col-sm-6 col-xl-3">
					<div class="card">
						<div class="card-body">
							<div class="media">
								<div class="media-body">
									<h5 class="font-size-18 font-weight-400">Actions Completed</h5>
									<h4 class="m-0 align-self-center font-weight-700 theme_coLor"><?php echo $numcatakeactioncompleted;?></h4>
								</div>
								<div class="avatar-xs">
									<span class="avatar-title rounded-circle">
