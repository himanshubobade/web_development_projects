				 ...
				 <form method="post" enctype="multipart/form-data" action="<?= base_url() ?>update-campus-ambasadors">
					...
					<div class="col-md-8">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                            <input placeholder="Name of email address" required class="form-control" name="email" value="<?php echo $campusambasador->email; ?>" />
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                            <input placeholder="Name of email address" required class="form-control" name="email" value="<?php echo $campusambasador->mobile; ?>" />
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                              <select class="form-control" name="college" >
												...
												<option value="<?php echo $college->name; ?>" <?php if($college->id==$campusambasador->college){?> selected <?php }?>><?php echo $college->name; ?></option>
												<?php }?>
											</select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
											...
											<select class="form-control" name="country"  id="country"  >
												...
												<option value="<?php echo $countries->name; ?>"  <?php if($countries->id==$campusambasador->country){?> selected <?php }?>><?php echo $countries->name; ?></option>
												<?php }?>
											</select>
                                            </div>
                                        </div>
                                        <div class="form-group row">
											...
											<select class="form-control" name="state"  id="state"  >
												...
												<option value="<?php echo $states->name; ?>"  <?php if($states->id==$campusambasador->state){?> selected <?php }?> ><?php echo $states->name; ?></option>
												<?php }?>
											</select>
                                            </div>
                                        </div>
                                        <div class="form-group row">
											...
											<select class="form-control" name="city"  id="city" >
												...
												<option value="<?php echo $city->name; ?>"  <?php if($city->name==$campusambasador->city){?> selected <?php }?> ><?php echo $city->name; ?></option>
												<?php }?>
											</select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10"> 
                                                <input placeholder="Description" required class="form-control" name="description" value="<?php echo $campusambasador->description; ?>" />
                                            </div>
                                        </div>
