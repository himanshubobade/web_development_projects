...
class CaTask extends CI_Controller {
  ...
  public function ca_task_update()
	...
	public function ca_takeaction()
	{
		...
		$data['numpointsca'] = $this->Read_model->capointscount($campusambasador);
		$data['numcatakeactioncompleted'] = $this->Read_model->catakeactioncompletecount(); 
		#$data['numrowsca'] = $this->Read_model->cacount();
		#$data['numrowscatask'] = $this->Read_model->cataskcount();
		#$data['numrowscatakeaction'] = $this->Read_model->catakeactioncount();
		#$data['numrowscountryambassador'] = $this->Read_model->countryambasadorcount();  
		$this->load->view('include/header',$data);
		$this->load->view('catakeaction',$data);
		$this->load->view('include/footer');
	}
