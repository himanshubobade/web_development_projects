...
$route['hello-admin/ca-actions/edit-ca-actions/(:num)'] = 'CaAction/edit_ca_takeaction/$1';
...
$route['hello-admin/ca-actions/action-request'] = 'CaAction/ca_action_request';
...
$route['ca-actions'] =  'CaAction/ambassodor_actions';
$route['submit-report'] = 'CaTask/submit_report';
$route['action-submit-report'] = 'CaAction/submit_report';
$route['submit-report/submit'] = 'CaTask/task_submit_report';

$route['submit-actionreport'] = 'CaAction/submit_actionreport';
$route['submit-actionreport/submit'] = 'CaAction/task_submit_actionreport';
