                                            ...
                                            <table id="datatable" class="table table-bordered dt-responsive " >
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
														...
														<td><?php echo $key->flag?></td>
														<td><?php echo $key->points?></td>
														<td><input type="button" onClick="approveflag(<?php echo $key->flag; ?>)" name="Approve" value="Approve"></td>
                                                        <td><a href="<?= base_url() ?>hello-admin/task-submissions" class="btn btn-dark waves-effect waves-light">Approve</a></td>
														<!--<script language="javascript">
															function approveflag(flagid){
																if(confirm("Do you want to approve this task?")){
																	window.location.href='controllers/CaTask.php' +flagid+'';
																	return true;
																}
															}
														</script>-->
