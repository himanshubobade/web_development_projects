...
---------------------------------------------------    
---------------------------------------------------
CAUTION REMOVE THE COMMENT BAR TO GIVE ONE MORE DIV
---------------------------------------------------
---------------------------------------------------
-->
				...
				<div class="card-body">
				 <form method="post" enctype="multipart/form-data" action="<?= base_url() ?>update-campus-ambasadors">
					...
					<div class="col-md-8">
                                        ...
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-md-2 col-form-label">Description(User Bio)</label>
                                            <div class="col-md-10">
                                                <input placeholder="Description of CA" required class="form-control" name="description" value="<?php echo $campusambasador->description; ?>" />
                                            </div>
                                        </div>
                                        <div class="form-group row">
