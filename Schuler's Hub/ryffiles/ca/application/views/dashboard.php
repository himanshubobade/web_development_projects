				...
				<div class="card-body">
					<div class="row">
						...
						<div class="col-md-7 mb-3">
							...
							<p class="font-weight-600"><?php echo $campusambasador->college;?></p>
							<p class=""><?php echo $campusambasador->description;?></p>
							<a href="<?= base_url() ?>" class="btn btn-primary mt-2" >Update Your Profile</a>
						</div>
						<div class="col-md-3">
							<div class="media">
								<div>
								...
								<div class="media-body ml-2 mt-1">
									<h5 class="font-16"><?php echo $campusambasador->mobile;?></h5>
								</div>
							</div>
							<div class="media">
								<div>
								...
								<div class="media-body ml-2 mt-1">
									<h5 class="font-16"><?php echo $campusambasador->email;?></h5>
								</div>
							</div>
							<div class="media">
								<div>
								...
								<div class="media-body ml-2 mt-1">
									<h5 class="font-16"><?php echo $campusambasador->residence;?>,Raipur, CG</h5>
								</div>
							</div>
				...
				<div class="col-sm-6 col-xl-3">
					<div class="card">
						<div class="card-body">
							<div class="media">
								<div class="media-body">
									<h5 class="font-size-18 font-weight-400">Number of Auctions</h5>
									<h4 class="m-0 align-self-center font-weight-700 theme_coLor">1,753</h4>
								</div>
								<div class="avatar-xs">
									<span class="avatar-title rounded-circle">
			...
			<div class="mb-4">
				<div class="row">
					...
					<div class="col-md-12 text-center">
						<a href="#" class="btn btn-primary">View More Action</a>
					</div>
				</div>
			</div>
		</div>
