                                            ...
                                            <table id="datatable" class="table table-bordered dt-responsive " >
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
														...
														<form method="post" action="<?= base_url() ?>hello-admin/campus-ambasadors/update-campus-ambasadors/update">
                                                        	<td><a href="<?= base_url() ?>hello-admin/task-submissions<?php #echo $key->id;?>" class="btn btn-dark waves-effect waves-light">Approve</a></td>
														</form>
                                                    </tr>
