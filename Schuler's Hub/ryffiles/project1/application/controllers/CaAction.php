...
class CaAction
 extends CI_Controller {
    ...
    public function ambassodor_actions()
	{
        ...
        $data['details1'] = $this->Read_model->read_action($campusambasador);  
	...
	public function submit_actionreport()
	{
		...
		$data['campusambasador'] = $ambasadors; 
        $data['error'] ="";
        #$data['details'] = $this->Read_model->read_task($campusambasador);//used for dropdown at submit action report
		$this->load->view('include/header',$data);
