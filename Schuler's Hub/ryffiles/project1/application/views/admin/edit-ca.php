                    ...
                    <div class="container-fluid">
                                ...
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="<?= base_url() ?>hello-admin/campus-ambasadors">Campus Ambasador</a></li>
                                            <li class="breadcrumb-item active">Add Campus Ambasador</li>
                                        </ol>
                                    </div>
						...
						<div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body"> 
									<form method="post" enctype="multipart/form-data" action="<?= base_url() ?>hello-admin/campus-ambasadors/update-campus-ambasadors/update">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <input placeholder="Email Address" required class="form-control" name="email" value="<?php echo $campusambasador->email; ?>"/>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-md-2 col-form-label  font-18 font-weight-400">Mobile Number</label>
                                            <div class="col-md-10">
                                                <input placeholder="Mobile Number" required type="number" class="form-control" name="mobile"  value="<?php echo $campusambasador->mobile; ?>"/>
                                            </div>
                                        </div>
                                        <div class="form-group row">
