						...
						<div class="row">
                            <div class="col-12">
                                <div class="card">
									...
									<form method="post" enctype="multipart/form-data" action="<?= base_url() ?>hello-admin/campus-ambasadors/add-new-campus-ambasadors/submit">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-10">
                                                <button type="submit" class="btn btn-primary mt-2" name="para" value="">Add Campus Ambasador</button>
                                            </div>
                                        </div>
