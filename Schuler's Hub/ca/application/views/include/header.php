                        ...
                        <div class="dropdown d-inline-block">
                            <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                                ...
                                <img class="rounded-circle header-profile-user" src="<?= base_url() ?>assets/ms-icon-310x310.png"
                                    alt="Header Avatar">
                                <span class="d-none d-sm-inline-block ml-1"><?php echo $campusambasador->name; ?></span>
                ...
                <div data-simplebar class="h-100">
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                                <a href="<?= base_url() ?>cadashboard" class="waves-effect">
                           ...
                           <li>
                            ...
                            <li>
                                <a href="<?= base_url() ?>camyaction" class="waves-effect">
                                    <i class="mdi mdi-view-dashboard"></i>
                                    <span>My action</span>
                                </a>
                            </li>
                            <li>
                                <a href="<?= base_url() ?>caresources" class="waves-effect">
                                    <i class="mdi mdi-view-dashboard"></i>
                                    <span>Resources</span>
                                </a>
                            </li>
