                                ...
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="<?= base_url() ?>hello-admin/campus-ambasadors">Country Ambasador</a></li>
                            ...
                            <div class="col-12">
                                <div class="card">
									...
									<form method="post" enctype="multipart/form-data" action="<?= base_url() ?>hello-admin/country-ambasadors/update-country-ambasadors/update">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-10">
                                                <button type="submit" class="btn btn-primary mt-2" name="campusambasador" value="<?php echo $countryambasador->id; ?>">Update Country Ambasador</button>
                                            </div>
                                        </div>
